...
It seems like the higher models, I ran out of CUDA memory that I am allocated in the Bridges-2, so let's go with more basic model
'''
...
# Make predictions on the test dataset
    ...
    trainer = pl.Trainer(max_epochs=11, accelerator='gpu' if torch.cuda.is_available() else 'cpu')
