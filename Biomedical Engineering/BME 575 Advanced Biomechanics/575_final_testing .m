...
for i=1:timepoints
    ...
    syms n 
    sums=symsum(-((Ha*v0*t)/height)-(((2*v0*height)/(k*pi^2))*((1/n^2)*(1-exp(((-n^2)*(pi^2)*Ha*k*t)/height^2)))),1,inf  )
    -((Ha*v0*t)/height)-(((2*v0*height)/(k*pi^2))*(sums)
    syms n 
    symsum(-((Ha*v0*t0)/height)-(((2*v0*height)/(k*pi^2))*((1/n^2)*(1-exp(((-n^2)*(pi^2)*Ha*k*(t-t0)/height^2)))),1,inf  )
